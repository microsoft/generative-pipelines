...
{
    /// <summary>
    /// Scan directory for .NET .csproj files (ignoring projects starting with "_")
    /// </summary>
    /// <returns>List of service names and csproj files</returns>
    public static IEnumerable<(string name, string projectFilePath)> FindDotNetProjects(string path)
    {
    ...
    public static IEnumerable<(string name, string dirName)> FindNodeJsProjects(string path)
    {
    ...
    /// </summary>
    /// <returns>List of services and dir names</returns>
    public static IEnumerable<(string name, string dirName)> FindPythonProjects(string path)
    {
