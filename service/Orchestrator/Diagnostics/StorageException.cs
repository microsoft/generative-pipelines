...
public class StorageException : AppException
{
    ...
    public StorageException(bool? isTransient = null)
    {
    ...
    /// <param name="isTransient">Optional parameter to indicate if the error is temporary and might disappear by retrying.</param>
    public StorageException(string? message, bool? isTransient = null) : base(message)
    {
        this.IsTransient = isTransient;
    }
    ...
    /// <param name="isTransient">Optional parameter to indicate if the error is temporary and might disappear by retrying.</param>
    public StorageException(string? message, Exception? innerException, bool? isTransient = null) : base(message, innerException)
    {
        this.IsTransient = isTransient;
    }
}
